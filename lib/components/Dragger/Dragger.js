...
var Dragger = (function (_super) {
    ...
    Dragger.prototype.render = function () {
        ...
        var items = React.Children.map(childrenNode, function (element, index) {
            if (!element) {
                return element;
            }
        ...
        return (React.createElement(styled_1.StyledDragger, { ref: this.draggerRef, className: classes, style: style, onDragOver: self.dragOver }, items));
    };
    return Dragger;
