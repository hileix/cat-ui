...
var DraggerItem = (function (_super) {
    ...
    DraggerItem.prototype.render = function () {
        ...
        return (React.createElement(styled_1.StyledDraggerItem, { draggable: true, "data-order": order, onDragStart: onDragStart, onDragEnd: onDragEnd, className: classes, style: style }, children));
    };
    return DraggerItem;
