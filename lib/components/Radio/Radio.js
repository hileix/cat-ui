...
var Radio = (function (_super) {
    ...
    Radio.prototype.render = function () {
        ...
        var classes = classnames_1.default('hmly-radio', {
        ...
        return (React.createElement(styled_1.StyledRadioBox, { className: classes, style: style },
            React.createElement(styled_1.StyledRadio, null,
                React.createElement(styled_1.RadioInner, { checked: checked }),
                React.createElement(styled_1.RadioInput, { value: value, checked: checked, disabled: disabled, readOnly: readOnly, onClick: this.handleClick, onChange: this.handleClick })),
            React.createElement(styled_1.RadioSlot, null, children)));
    };
    return Radio;
}(react_1.Component));
