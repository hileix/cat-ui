...
var Radio = /** @class */ (function (_super) {
    ...
    Radio.prototype.render = function () {
        var _a = this.props, className = _a.className, style = _a.style, disabled = _a.disabled, readOnly = _a.readOnly, checked = _a.checked, value = _a.value, layout = _a.layout, children = _a.children;
        var classes = classnames_1.default('hmly-radio', className, "" + layout);
        return (React.createElement(styled_1.StyledRadioBox, { className: classes, style: style },
            React.createElement(styled_1.StyledRadio, { className: layout },
            ...
            React.createElement(styled_1.RadioSlot, { disabled: disabled, className: layout }, children)));
    };
    Radio.defaultProps = {
        layout: 'horizontal'
    };
