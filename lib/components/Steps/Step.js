...
var Step = (function (_super) {
    ...
    Step.prototype.render = function () {
        ...
        var classes = classnames_1.default({ prefix: 'hmly-steps-step', theme: theme });
        return (React.createElement(styled_1.StyledStep, { className: classes() },
            ...
            React.createElement("div", { className: classes('content') },
                React.createElement("div", { className: "" + classes('content-title') },
                    title,
                    React.createElement("span", { className: classes('content-title-stripe') })),
