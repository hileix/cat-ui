...
var Tabs = (function (_super) {
    ...
    function Tabs() {
        ...
        _this.toRenderNav = function (navs) {
        ...
        _this.toRenderContent = function (contents) {
            var activeId = _this.props.activeId;
    ...
    Tabs.prototype.render = function () {
        ...
        return (React.createElement(styled_1.StyledTabs, { className: className, style: style },
            React.createElement(styled_1.TabsNavBox, null, this.toRenderNav(navs)),
            React.createElement(styled_1.TabsContentBox, null, this.toRenderContent(contents))));
    };
    Tabs.TabsPanel = TabPanel_1.default;
    return Tabs;
}(react_1.Component));
