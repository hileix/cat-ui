...
var Modal = (function (_super) {
    ...
    function Modal() {
        ...
        _this.toRenderFooter = function () {
            var _a = _this.props, footer = _a.footer, okText = _a.okText, cancelText = _a.cancelText;
            if (footer) {
                return footer;
            }
            else {
                return (React.createElement(index_1.ModalFooter, null,
                    cancelText.length > 0 && React.createElement(components_1.Button, { theme: 'white-primary', onClick: _this.onMaskClick }, cancelText),
    ...
    Modal.prototype.render = function () {
        var _a;
        var _b = this.props, prefix = _b.prefix, className = _b.className, style = _b.style, theme = _b.theme, size = _b.size, width = _b.width, disabled = _b.disabled, visible = _b.visible, title = _b.title, okText = _b.okText, cancelText = _b.cancelText, align = _b.align, children = _b.children, others = __rest(_b, ["prefix", "className", "style", "theme", "size", "width", "disabled", "visible", "title", "okText", "cancelText", "align", "children"]);
            ...
            React.createElement(index_1.ModalBox, { className: classes, style: style, onClick: this.onMaskClick },
                React.createElement(index_1.InnerModal, null,
                    React.createElement(index_1.ModalHeader, null,
                        title,
                        React.createElement(index_1.CloseBox, null,
