...
var Popover = (function (_super) {
    ...
    function Popover(props) {
        ...
        _this.removePopover = function (e) {
            ...
            var node = e.target;
            var fixedNode = node.closest('[data-fixed]');
            var triggerDOM = _this.popoverRef.current;
            var isNotFixed = fixedNode ? !fixedNode.dataset.fixed : true;
            console.log('node', node, fixedNode, isNotFixed, fixedNode.dataset.fixed);
            var isNotContains = triggerDOM.contains(node) === false;
        ...
        _this.renderContent = function (content) {
            var _a = _this.props, mode = _a.mode, position = _a.position, offsetX = _a.offsetX, offsetY = _a.offsetY;
            var visible = _this.state.visible;
