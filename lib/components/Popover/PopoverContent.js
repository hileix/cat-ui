...
var PopoverContent = (function (_super) {
    ...
    function PopoverContent(props) {
        ...
        _this.adjustPosition = function () {
            ...
            switch (position) {
                case 'topCenter':
                    newPositionStyle = __assign({}, positionStyle, { left: triggerRect.left + (triggerRect.width / 2) - (contentRect.width / 2) + offsetX, top: window.pageYOffset + triggerRect.top - contentRect.height - 5 + offsetY });
                    break;
                case 'bottomCenter':
