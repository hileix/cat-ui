...
var Tooltip = (function (_super) {
    ...
    Tooltip.prototype.componentDidUpdate = function () {
        ...
        var _a = this.state, isPopOpen = _a.isPopOpen, tipTop = _a.tipTop, tipLeft = _a.tipLeft;
    ...
    Tooltip.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className, style = _b.style, mode = _b.mode, content = _b.content, position = _b.position, children = _b.children;
        var _c = this.state, isPopOpen = _c.isPopOpen, tipTop = _c.tipTop, tipLeft = _c.tipLeft;
        ...
        return (React.createElement(Popover_1.default, { visible: isPopOpen, mode: mode, position: position, onChange: this.onPopoverChange },
            ...
            React.createElement(Popover_1.default.Content, null,
                React.createElement(styled_1.StyledTooltipContent, { ref: this.contentRef, className: contentClass, top: tipTop, left: tipLeft }, content))));
    };
