...
var Tooltip = (function (_super) {
    ...
    Tooltip.prototype.render = function () {
        ...
        return (React.createElement(__1.Popup, { prefixClx: prefixCls, className: classes, innerCls: 'hi-children', style: style, placement: placement, title: title, trigger: trigger, onChange: this.handleChange }, children));
    };
