...
var Button = (function (_super) {
    ...
    function Button() {
        ...
        _this.handleClick = function (event) {
            ...
            console.log('Button: handleClick', disabled);
            if (disabled)
                return;
    ...
    Button.prototype.render = function () {
        ...
        var classes = classnames_1.default(prefix + "-button", (_a = {},
            ...
            _a), className);
        return (React.createElement(styled_1.StyledButton, __assign({ className: classes, style: style, onClick: this.handleClick }, others), children));
    };
    Button.defaultProps = {
        prefix: 'hmly',
        htmlType: 'button',
