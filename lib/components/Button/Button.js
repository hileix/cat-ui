...
var Button = (function (_super) {
    ...
    function Button(props) {
        ...
        _this.setBtnUp = lodash_1.debounce(function (e) {
        ...
        _this.setBtnDown = lodash_1.debounce(function () {
            var theme = _this.props.theme;
            if (theme === 'primary-up') {
                var btnDOM = _this.buttonRef.current;
    ...
    Button.prototype.render = function () {
        ...
        var classes = classnames_1.default(prefix + "-button", (_a = {},
            ...
            _a), className);
        return (React.createElement(styled_1.StyledButton, { ref: this.buttonRef, className: classes, style: style, type: htmlType, disabled: disabled, onClick: this.handleClick, onMouseEnter: this.setBtnUp, onMouseLeave: this.setBtnDown, onMouseDown: this.setBtnDown, onMouseUp: this.setBtnUp }, children));
    };
    Button.defaultProps = {
        prefix: 'hmly',
        htmlType: 'button',
