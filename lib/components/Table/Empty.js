...
var empty_png_1 = require("./styled/empty.png");
var Empty = (function (_super) {
    ...
    Empty.prototype.render = function () {
        ...
        var defaultEmpty = (React.createElement(styled_1.EmptyInner, null,
            React.createElement(styled_1.EmptyImg, { src: empty_png_1.default }),
