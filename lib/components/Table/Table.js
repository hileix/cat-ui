...
var Table = (function (_super) {
    ...
    Table.prototype.render = function () {
        var _a = this.props, className = _a.className, style = _a.style, columns = _a.columns, dataSource = _a.dataSource, align = _a.align;
        ...
        return (React.createElement(styled_1.StyledTable, { className: classes, style: style },
            React.createElement("table", { className: 'table' },
                ...
                React.createElement("tbody", null, dataSource.map(function (elem, index) {
