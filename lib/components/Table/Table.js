...
var Table = (function (_super) {
    ...
    Table.prototype.render = function () {
        ...
        var _b = this.props, className = _b.className, style = _b.style, columns = _b.columns, align = _b.align, draggable = _b.draggable, pagination = _b.pagination, empty = _b.empty, emptyText = _b.emptyText, draggedElement = _b.draggedElement, onDragEnd = _b.onDragEnd, onSort = _b.onSort;
        var current = pagination.current, pageSize = pagination.pageSize;
