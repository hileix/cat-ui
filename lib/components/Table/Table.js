...
var Table = (function (_super) {
    ...
    function Table() {
        ...
        _this.onFilterSelect = function (value) {
    ...
    Table.prototype.render = function () {
        ...
        return (React.createElement(styled_1.StyledTableBox, { className: classes, style: style },
            React.createElement("table", { className: 'table' },
                React.createElement(TableHeader_1.default, { columns: columns, align: align, onFilterSelect: this.onFilterSelect }),
                React.createElement(TableBody_1.default, { columns: columns, align: align, dataSource: dataSource, empty: empty, emptyText: emptyText }))));
    };
    Table.defaultProps = {
        align: 'left',
        emptyText: ''
