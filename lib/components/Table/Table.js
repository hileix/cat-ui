...
var Table = (function (_super) {
    ...
    Table.prototype.render = function () {
        var _a = this.props, className = _a.className, style = _a.style, columns = _a.columns, dataSource = _a.dataSource, align = _a.align, empty = _a.empty;
        ...
        return (React.createElement(styled_1.StyledTableBox, { className: classes, style: style },
            React.createElement("table", { className: 'table' },
                ...
                React.createElement(TableBody_1.default, { columns: columns, align: align, dataSource: dataSource, empty: empty }))));
    };
    Table.defaultProps = {
        align: 'left',
        empty: ''
