...
var Table = (function (_super) {
    ...
    function Table(props) {
        ...
        _this.onFilterSelect = function (id, value) {
            ...
            var filterDataSource = dataSource.filter(function (elem, index) {
    ...
    Table.prototype.render = function () {
        ...
        var _b = this.props, className = _b.className, style = _b.style, columns = _b.columns, align = _b.align, pagination = _b.pagination, empty = _b.empty, emptyText = _b.emptyText;
        var current = pagination.current, pageSize = pagination.pageSize;
        ...
        return (React.createElement(styled_1.StyledTableBox, { className: classes, style: style },
            React.createElement("table", { className: 'table' },
                ...
                React.createElement(TableBody_1.default, { align: align, columns: columns, currentPageData: currentPageData, empty: empty, emptyText: emptyText })),
            this.hasPagination() && React.createElement(styled_1.StyledPaginationBox, null,
