...
var TableBody = (function (_super) {
    ...
    function TableBody() {
        ...
        _this.renderTrs = function () {
            var _a = _this.props, columns = _a.columns, currentPageData = _a.currentPageData, align = _a.align, filterKeys = _a.filterKeys, pagination = _a.pagination;
            ...
            return currentPageData.map(function (elem, index) {
