...
var TableBody = (function (_super) {
    ...
    TableBody.prototype.render = function () {
        var _a = this.props, columns = _a.columns, dataSource = _a.dataSource, align = _a.align, emptyText = _a.emptyText;
        ...
        return (React.createElement("tbody", null, dataSource.length === 0
            ? React.createElement(Empty_1.default, { colSpan: colSpan, emptyText: emptyText })
            : (trs)));
    };
    return TableBody;
}(react_1.Component));
