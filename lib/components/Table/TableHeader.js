...
var TableHeader = (function (_super) {
    ...
    function TableHeader() {
        ...
        _this.onFilterClick = function (value) {
                            ...
                            React.createElement(Popover_1.default, { mode: 'click' },
                                ...
                                React.createElement(Popover_1.default.Content, null,
                                    React.createElement("div", { className: 'pop-content-menu' },
                                        React.createElement(Menu_1.default, { mode: 'pop', className: 'menu1' }, elem.filters.map(function (item) {
                                            return (React.createElement(Menu_1.default.Item, { key: item.value, onClick: function () { self.onFilterClick(item.value); } },
                                                React.createElement(Radio_1.default, { value: item.value }, item.text)));
                                        }))))))));
            });
        };
        return _this;
