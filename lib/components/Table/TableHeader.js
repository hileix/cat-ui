...
var TableHeader = (function (_super) {
    ...
    function TableHeader() {
        ...
        _this.renderTds = function () {
            ...
            var _b = filterKeys.id, id = _b === void 0 ? '' : _b, _c = filterKeys.value, value = _c === void 0 ? 'all' : _c;
            var isAllSelect = value === 'all';
                                ...
                                React.createElement(Popover_1.default.Content, null,
                                    React.createElement("div", { className: 'pop-content-menu' },
                                        React.createElement(Menu_1.default, { mode: 'pop', className: 'menu1' },
                                            ...
                                            React.createElement(Menu_1.default.Item, { key: 'all', onClick: function () { self.onFilterClick(elem.id, 'all'); } },
                                                React.createElement(Radio_1.default, { checked: isAllSelect, value: 'all' }, elem.filterAllText)))))))));
            });
        };
        return _this;
    }
