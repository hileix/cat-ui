...
var TableTr = (function (_super) {
    ...
    TableTr.prototype.render = function () {
        ...
        var id = data.id;
        var classes = classnames_1.default('hmly-table-row', "hmly-table-row-" + align, { 'hmly-table-row-dragging': dragging });
        var tds = this.renderTds();
        return (React.createElement(styled_1.StyledTr, { draggable: draggable, "data-order": order, id: id, onDragStart: this.handleDragStart, onDragEnd: this.handleDragEnd, className: classes }, tds));
    };
    return TableTr;
}(react_1.Component));
