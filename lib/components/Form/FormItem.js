...
var FormItem = (function (_super) {
    ...
    FormItem.prototype.render = function () {
        var self = this;
        var _a = this.props, className = _a.className, style = _a.style, name = _a.name, label = _a.label, desc = _a.desc, tips = _a.tips, labelWidth = _a.labelWidth, labelAlign = _a.labelAlign, labelOffset = _a.labelOffset, required = _a.required, values = _a.values, errors = _a.errors, children = _a.children;
        var classes = classnames_1.default('hmly-form-item', className);
        var labelClass = classnames_1.default({ 'hmly-form-label-required': required });
        var value = values[name];
        var error = errors[name];
