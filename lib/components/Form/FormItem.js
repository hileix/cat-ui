...
var FormItem = /** @class */ (function (_super) {
    ...
    FormItem.prototype.render = function () {
        var self = this;
        var _a = this.props, className = _a.className, style = _a.style, name = _a.name, label = _a.label, desc = _a.desc, tips = _a.tips, labelWidth = _a.labelWidth, labelAlign = _a.labelAlign, labelOffset = _a.labelOffset, labelMarginTop = _a.labelMarginTop, required = _a.required, values = _a.values, errors = _a.errors, colon = _a.colon, children = _a.children;
        ...
        return (React.createElement(styled_1.StyledFormItem, { className: classes, style: style, ref: this.formItemRef },
            React.createElement(styled_1.LabelBox, { width: labelWidth, align: labelAlign, offset: labelOffset, marginTop: labelMarginTop },
