...
var StyledIcon = styled_components_1.default.span(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  cursor: pointer;\n  position: absolute;\n  top: 50%\n  transform: translate(0, -50%);\n  z-index: 1;\n  width: 10px;\n  height: 10px;\n  right: 5.5%;\n  color: ", ";\n  font-size: ", ";\n"], ["\n  cursor: pointer;\n  position: absolute;\n  top: 50%\n  transform: translate(0, -50%);\n  z-index: 1;\n  width: 10px;\n  height: 10px;\n  right: 5.5%;\n  color: ", ";\n  font-size: ", ";\n"])), function (props) { return (props.state === 3 /* error */ ? theme_1.colorRedPrimary : theme_1.colorPrimary); }, function (props) { return props.showClear ? '10px' : '16px'; });
