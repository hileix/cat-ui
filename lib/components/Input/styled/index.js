...
var fly = styled_components_1.keyframes(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  from {\n    font-size: 16px;\n    color: ", ";\n    background-color: transparent;\n    transform: translate(0, -50%);\n    top: 50%;\n  }\n\n  to {\n    font-size: 12px;\n    color: ", ";\n    background-color: #ffffff;\n    transform: translate(0, 0);\n    top: -16%;\n  }\n"], ["\n  from {\n    font-size: 16px;\n    color: ", ";\n    background-color: transparent;\n    transform: translate(0, -50%);\n    top: 50%;\n  }\n\n  to {\n    font-size: 12px;\n    color: ", ";\n    background-color: #ffffff;\n    transform: translate(0, 0);\n    top: -16%;\n  }\n"])), theme_1.colorTertiary, theme_1.colorPrimary);
var StyledWrapperPlaceholder = styled_components_1.default.span(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: ", ";\n  position: absolute;\n  top: 50%\n  z-index: 2;\n  left: ", ";\n  transform: translate(0, -50%);\n  font-size: 16px;\n  font-weight: normal;\n  transition: all .3s;\n  animation: ", " .2s ease-out forwards;\n"], ["\n  display: ", ";\n  position: absolute;\n  top: 50%\n  z-index: 2;\n  left: ", ";\n  transform: translate(0, -50%);\n  font-size: 16px;\n  font-weight: normal;\n  transition: all .3s;\n  animation: ", " .2s ease-out forwards;\n"])), function (props) { return ((props.state === 2 || props.state === 3) ? 'block' : 'none'); }, function (props) { return (props.theme === 'box' || props.theme === 'box-pwd' ? '20px' : 0); }, function (props) { return ((props.state === 2 || props.state === 3) && fly); });
exports.StyledWrapperPlaceholder = StyledWrapperPlaceholder;
var StyledWrapperMsg = styled_components_1.default.span(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  display: block;\n  font-size: 12px;\n  color: ", ";\n  font-weight: normal;\n  margin-top: 8px;\n"], ["\n  display: block;\n  font-size: 12px;\n  color: ", ";\n  font-weight: normal;\n  margin-top: 8px;\n"])), function (props) { return (props.state === 3 ? theme_1.colorRedPrimary : theme_1.colorPrimary); });
