...
var Input = (function (_super) {
    ...
    Input.prototype.handleContent = function (e) {
    ...
    Input.prototype.render = function () {
        ...
        var _b = this.props, size = _b.size, className = _b.className, message = _b.message, placeholder = _b.placeholder, placeholderOrigin = _b.placeholderOrigin, showClear = _b.showClear, showEye = _b.showEye;
