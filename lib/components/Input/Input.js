...
var Input = (function (_super) {
    ...
    Input.prototype.render = function () {
        ...
        return (React.createElement(Wrapper_1.default, { theme: theme, size: size, state: inputState, className: className, placeholder: placeholder, message: message, showClear: showClear, showEye: showEye },
