...
var Input = (function (_super) {
    ...
    Input.prototype.iconMouseDown = function () {
        this.isIconBlur = true;
    };
    Input.prototype.iconMouseUp = function () {
        this.input.current.focus();
    ...
    Input.prototype.render = function () {
        ...
        return (React.createElement(Wrapper_1.default, { value: value, theme: theme, size: size, state: inputState, className: className, placeholder: !placeholderOrigin && placeholder, message: message, showClear: showClear, showEye: showEye },
            ...
            React.createElement(styled_1.StyledIcon, { showClear: showClear, showEye: showEye, style: iconStyle, onMouseDown: this.iconMouseDown.bind(this), onMouseUp: this.iconMouseUp.bind(this) },
