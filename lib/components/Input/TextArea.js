...
var TextArea = /** @class */ (function (_super) {
    ...
    function TextArea(props) {
        ...
        var inputState = props.error ? 3 /* error */ : 0 /* default */;
        _this.state = {
            value: value,
