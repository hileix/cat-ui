...
var Menu = (function (_super) {
    ...
    Menu.prototype.render = function () {
        var _a;
        var self = this;
        var _b = this.props, className = _b.className, style = _b.style, mode = _b.mode, activeKey = _b.activeKey, children = _b.children;
        ...
        var items = React.Children.map(children, function (element, index) {
            ...
            console.log('element', element.key, element.props);
