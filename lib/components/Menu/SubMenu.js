    ...
    function SubMenu(props) {
        ...
        _this.onMouseEnter = function () {
            ...
            _this.enterTimer = setTimeout(function () {
                _this.setState({ popMenuVisible: true });
            }, 200);
        };
        ...
        _this.renderContent = function () {
            ...
            if (mode === 'inline') {
                subMenuItems = (React.createElement(React.Fragment, null,
                    subMenuTitle,
                    React.createElement(styled_1.InlineSubMenu, null, children)));
            }
            if (mode === 'pop') {
                subMenuItems = (React.createElement(React.Fragment, null,
                    subMenuTitle,
                    popMenuVisible && React.createElement(styled_1.PopSubMenuBox, null,
                        React.createElement(styled_1.PopSubMenu, null, children))));
            }
            if (mode === 'replace') {
