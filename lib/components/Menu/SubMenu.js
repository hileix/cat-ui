...
var SubMenu = (function (_super) {
    ...
    function SubMenu(props) {
        ...
        _this.popSubMenuWidth = 'auto';
        _this.popSubMenuRight = 'auto';
        ...
        _this.onSubMenuTitleClick = function () {
            ...
            var _a = _this.props, mode = _a.mode, onSwitchMenu = _a.onSwitchMenu, backHeader = _a.backHeader, children = _a.children;
            if (mode === 'inline') {
        ...
        _this.renderContent = function () {
            ...
            if (mode === 'pop') {
                var popDOM = _this.popSubMenuRef.current;
                var popRect = popDOM && popDOM.getBoundingClientRect();
                var _d = (popRect || {}).width, width = _d === void 0 ? 'auto' : _d;
                if (_this.popSubMenuWidth === 'auto' && width !== 'auto') {
                    _this.popSubMenuWidth = width + 'px';
                    _this.popSubMenuRight = '-' + _this.popSubMenuWidth;
                }
                subMenuItems = (React.createElement(React.Fragment, null,
                    subMenuTitle,
                    isPopVisible && React.createElement(styled_1.PopSubMenuBox, { ref: _this.popSubMenuRef, right: _this.popSubMenuRight, width: _this.popSubMenuWidth },
        ...
        _this.popSubMenuRef = React.createRef();
        return _this;
    }
    SubMenu.prototype.componentWillUnmount = function () {
        this.setState = noop_1.default;
    };
